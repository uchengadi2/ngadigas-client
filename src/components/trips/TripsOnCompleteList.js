...
import { fetchFullfilledTrips } from "../../actions";
...
class TripsOnCompleteList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchFullfilledTrips(this.props.token, this.props.status);
  }
  ...
  renderOrdersList = () => {
    ...
    const columns = [
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(`/trips/completed/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
      ...
      //           history.push(`/trips/completed/cancel/${params.id}`),
      //         ]}
      //       />
      //     </strong>
      //   ),
      ...
      //           history.push(`/trips/completed/assign/${params.id}`),
      //         ]}
      //       />
      //     </strong>
      //   ),
      ...
      //           history.push(`/trips/completed/delete/${params.id}`),
      //         ]}
      //       />
      //     </strong>
      //   ),
...
const mapStateToProps = (state) => {
  ...
  return { trips: Object.values(state.tripFullfilled) };
};

export default connect(mapStateToProps, { fetchFullfilledTrips })(
  TripsOnCompleteList
);
