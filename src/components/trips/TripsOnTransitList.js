...
import { fetchOnTransitTrips } from "../../actions";
...
class TripsOnTransitList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchOnTransitTrips(this.props.token, this.props.status);
  }
  ...
  renderOrdersList = () => {
    ...
    const columns = [
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(`/trips/ontransit/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
      ...
      //           history.push(`/trips/ontransit/cancel/${params.id}`),
      //         ]}
      //       />
      //     </strong>
      //   ),
      ...
      //           history.push(`/trips/ontransit/assign/${params.id}`),
      //         ]}
      //       />
      //     </strong>
      //   ),
      ...
      //           history.push(`/trips/ontransit/delete/${params.id}`),
      //         ]}
      //       />
      //     </strong>
      //   ),
...
const mapStateToProps = (state) => {
  ...
  return { trips: Object.values(state.tripOnTransit) };
};

export default connect(mapStateToProps, { fetchOnTransitTrips })(
  TripsOnTransitList
);
