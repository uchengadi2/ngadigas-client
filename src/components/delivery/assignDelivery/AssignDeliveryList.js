...
import AssignDeliveryEditForm from "./AssignDeliveryEditForm";
import AssignDeliveryDelete from "./AssignDeliveryDelete";

class AssignDeliveryList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchDeliveries(this.props.token, this.props.status);
  }
          ...
          <strong>
            ...
            <EditRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/deliveries/assigned/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
...
export default connect(mapStateToProps, { fetchDeliveries })(
  AssignDeliveryList
);
