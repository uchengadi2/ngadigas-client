...
import { fetchReturnDeliveries } from "../../../actions";
import DataGridContainer from "../../DataGridContainer";

import ReturnDeliveryDelete from "./ReturnDeliveryDelete";
import ReturnDeliveryEditForm from "./ReturnDeliveryeditForm";

class ReturnDeliveryList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      editOpen: false,
  ...
  componentDidMount() {
    this.props.fetchReturnDeliveries(this.props.token, this.props.status);
  }
          ...
          <strong>
            ...
            <EditRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/deliveries/returned/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
