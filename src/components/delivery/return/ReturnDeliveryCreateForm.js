...
function ReturnDeliveryCreateForm(props) {
  ...
  const [deliveriesForTransit, setDeliveriesForTransit] = useState();
    ...
    if (dataValue) {
      const editForm = async () => {
        ...
        const response = await api.patch(
          `/deliveries/${deliveriesForTransit}`,
          dataValue
        );
  ...
  return (
    <div>
      <form id="returnDeliveryCreateForm" className={classes.formStyles}>
        <Grid
          item
          container
