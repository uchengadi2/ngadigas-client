...
import { fetchProductsOnSale } from "../../actions";
import DataGridContainer from "../DataGridContainer";
import ProductOnSaleEditForm from "./ProductOnSaleEditForm";
import ProductOnSaleDelete from "./ProductOnSaleDelete";
...
class ProductsOnSaleList extends React.Component {
  ...
  componentDidMount() {
    this.props.fetchProductsOnSale(this.props.token);
  }
  ...
  renderProductList = () => {
          ...
          <strong>
            ...
            <EditRoundedIcon
              onClick={() => [
                ...
                history.push(`/products/productsonsale/edit/${params.id}`),
              ]}
            />
          </strong>
        ),
          ...
          <strong>
            ...
            <DeleteRoundedIcon
              ...
              onClick={() => [
                ...
                history.push(`/products/productsonsale/delete/${params.id}`),
              ]}
            />
          </strong>
        ),
    ...
    this.props.productOnSales.map((sales) => {
      let row = {
        numbering: ++counter,
        id: sales.id,
        ...
        minimumQuantity: sales.minimumQuantity,
      };
      rows.push(row);
    });
...
const mapStateToProps = (state) => {
  return { productOnSales: Object.values(state.productOnSale) };
};

export default connect(mapStateToProps, { fetchProductsOnSale })(
  ProductsOnSaleList
);
