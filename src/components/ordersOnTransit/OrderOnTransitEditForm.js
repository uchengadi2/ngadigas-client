...
import { EDIT_ONTRANSIT_ORDER } from "../../actions/types";
...
function OrderOnTransitEditForm(props) {
  ...
  const [orderAssignment, setOrderAssignment] = useState(params.assignedOrder);
  ...
  const buttonContent = () => {
    return <React.Fragment> Update Order onTransit</React.Fragment>;
  };
  ...
  const onSubmit = (formValues) => {
    ...
    if (formValues["refNumber"]) {
      formValues["refNumber"] = formValues["refNumber"];
    }
    ...
    if (formValues) {
      const editForm = async () => {
        ...
        if (response.data.status === "success") {
          dispatch({
            type: EDIT_ONTRANSIT_ORDER,
            payload: response.data.data.data,
          });

          props.handleSuccessfulEditSnackbar(
            `${response.data.data.data.refNumber} Order delivery is updated successfully!!!`
          );
  ...
  const dateOfTransitCommencement = params.transitCommencementDate
    ? new Date(params.transitCommencementDate).toISOString().slice(0, 10)
    : "";
        ...
        <Grid container direction="row" style={{ marginTop: 10 }}>
          <Grid item style={{ width: "60%" }}>
            <Field
              ...
              id="crewLeaderName"
              name="crewLeaderName"
              defaultValue={params.crewLeaderName}
              type="text"
          ...
          <Grid item style={{ width: "39%", marginLeft: 5, marginTop: 0 }}>
            <Field
              ...
              defaultValue={params.crewLeaderPhoneNumber}
              type="text"
        ...
        <Grid container direction="row" style={{ marginTop: 10 }}>
          <Grid item style={{ width: "60%" }}>
            <Field
              ...
              defaultValue={params.crewFirstAssistantName}
              type="text"
          ...
          <Grid item style={{ width: "39%", marginLeft: 5, marginTop: 0 }}>
            <Field
              ...
              defaultValue={params.crewFirstAssistantPhoneNumber}
              type="text"
        ...
        <Grid container direction="row" style={{ marginTop: 10 }}>
          <Grid item style={{ width: "60%" }}>
            <Field
              ...
              defaultValue={params.crewSecondAssistantName}
              type="text"
          ...
          <Grid item style={{ width: "39%", marginLeft: 5, marginTop: 0 }}>
            <Field
              ...
              defaultValue={params.crewSecondAssistantPhoneNumber}
              type="text"
