...
import { EDIT_LOGISTICSPARTNER } from "../../actions/types";
...
function LogisticsPartnerEditForm(props) {
  const { params } = props;
  ...
  const [locationCountry, setLocationCountry] = useState(params.partnerCountry);
    ...
    if (data) {
      const editForm = async () => {
        ...
        const response = await api.patch(
          `/logisticspartners/${params.id}`,
          data
        );

        if (response.data.status === "success") {
          dispatch({
            type: EDIT_LOGISTICSPARTNER,
        ...
        >
          ...
          <Grid container direction="column" style={{ marginTop: 30 }}>
            ...
            <Grid container style={{ marginTop: 20 }}>
              <FormLabel style={{ color: "blue" }} component="legend">
                Enter Logistics Partner Contacts
              </FormLabel>
            </Grid>
            <Grid container direction="column" style={{ marginTop: 30 }}>
              <Grid item>
            ...
            <Grid container style={{ marginTop: 20 }}>
              <FormLabel style={{ color: "blue" }} component="legend">
                Enter Logistics Partner Bank Details
              </FormLabel>
            </Grid>
