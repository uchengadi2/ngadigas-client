...
import ReturnDeliveryCreateForm from "../delivery/return/ReturnDeliveryCreateForm";
import ReturnDeliveryList from "../delivery/return/ReturnDeliveryList";
...
function ReturnedDelivery({ token }) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/deliveries/returned/new"),
                ]}
              >
                Return Delivery
              </Button>
        ...
        <Grid item className={classes.contentContainer}>
          <ReturnDeliveryList token={token} />
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      <Dialog
...
export default ReturnedDelivery;
