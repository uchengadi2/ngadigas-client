...
import ProductsOnSaleList from "../productsOnSale/ProductsOnSaleList";
...
import ProductOnSaleCreateForm from "../productsOnSale/ProductOnSaleCreateForm";
...
function ProductsOnSaleLayout({ token, userId, vendorId, roleId }) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/products/productsonsale/new"),
                ]}
              >
...
export default ProductsOnSaleLayout;
