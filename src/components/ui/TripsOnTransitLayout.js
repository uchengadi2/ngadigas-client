...
import TripsOnTransitList from "../trips/TripsOnTransitList";
...
function TripsOnTransitLayout(props) {
  ...
  return (
    ...
    >
      ...
      <Dialog
        ...
        open={open}
        onClose={() => [setOpen(false), history.push("/trips")]}
      >
        <DialogContent>
          <OrderFormContainer
            token={props.token}
...
export default TripsOnTransitLayout;
