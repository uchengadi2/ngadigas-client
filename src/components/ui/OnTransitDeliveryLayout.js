...
function OnTransitDelivery({ token }) {
    ...
    >
      <Grid item container direction="column" sm={width}>
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/deliveries/ontransit/new"),
                ]}
              >
                Place Order on Transit
              </Button>
            </Grid>
            <Grid item></Grid>
          </Toolbar>
        ...
        <Grid item className={classes.contentContainer}>
          <OnTransitDeliveryList token={token} />
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      <Dialog
...
export default OnTransitDelivery;
