...
import RelatedProductCreateForm from "../relatedProducts/RelatedProductCreateForm";
...
function RelatedProductLayout({ token, userId, vendorId, roleId }) {
          ...
          <Toolbar disableGutters className={classes.toolbar}>
            <Grid item>
              <Button
                ...
                onClick={() => [
                  setOpen(true),
                  history.push("/products/relatedproducts/new"),
                ]}
              >
                Relate Product
              </Button>
...
export default RelatedProductLayout;
