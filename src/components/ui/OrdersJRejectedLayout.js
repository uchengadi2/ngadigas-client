...
import OrdersRejectedList from "../orders/OrdersRejectedList";
...
function OrdersRejectedLayout({ token }) {
    ...
    >
      <Grid item container direction="column" sm={width}>
        ...
        <Grid item className={classes.contentContainer}>
          <OrdersRejectedList token={token} />
          {/* <DataGridText /> */}
        </Grid>
      </Grid>
      <Dialog
...
export default OrdersRejectedLayout;
