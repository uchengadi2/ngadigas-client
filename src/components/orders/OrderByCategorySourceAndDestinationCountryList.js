...
function OrderByCategorySourceAndDestinationCountryList(props) {
    ...
    const fetchData = async () => {
      ...
      const response = await data.get("/orders", {
        params: {
          ...
          destinationCountry: props.selectedDestinationCountry,
...
export default OrderByCategorySourceAndDestinationCountryList;
