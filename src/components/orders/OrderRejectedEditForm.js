...
import { EDIT_REJECTEDORDER } from "../../actions/types";
...
function OrderRejectedEditForm(props) {
  const { params } = props;
  ...
  return (
    <div>
      <form id="orderRejectedEditForm" className={classes.formStyles}>
